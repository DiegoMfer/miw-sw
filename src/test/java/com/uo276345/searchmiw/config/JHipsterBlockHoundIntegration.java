...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.uo276345.searchmiw.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.uo276345.searchmiw.security.DomainUserDetailsService", "createSpringSecurityUser");
